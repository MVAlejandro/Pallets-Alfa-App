...
document.addEventListener("DOMContentLoaded", () => {
    ...
    container.innerHTML = 
        `<div id="movements-form-container" class="container py-4 collapse">
            <div class="row">
                <div class="col d-flex align-items-center">
                    <div class="mx-3">
                        <i class="bi bi-arrow-down-up icon-md" style="color:var(--primary-dark)"></i>
                    </div>
                    <h5 class="fw-bold">Nuevo Registro de Movimiento</h5>
                </div>
            ...
            <div class="tab-content" id="movements-tabs-content">
                ...
                <div class="tab-pane fade show active" id="tab-form-manual" role="tabpanel">
                    <form id="new-movement-form" autocomplete="off" class="p-3 pb-0">
                        <div class="row py-3">
                ...
                <div class="tab-pane fade" id="tab-form-excel" role="tabpanel">
                    <form id="new-excel-form" autocomplete="off" class="p-3 pb-0">
                        ...
                        <div class="d-flex align-items-center justify-content-end pt-1">
                            ...
                            <button id="btn-add-excel" type="submit" class="btn btn-primary d-flex align-items-center px-3 d-none" data-permission="movimientos.crear">
                                <i class="bi bi-floppy pe-1"></i>
                                <p class="ps-2">Agregar</p>
                            </button>
                        </div>
